...
//
    ...
    @GetMapping("/get/landlordposts/")
    @CrossOrigin
    public ResponseEntity<List<Landlordpost>> SearchLPost(@RequestParam Map<String, String> params) {

        if (params.get("lat") != null && params.get("lng") != null && params.get("radius") != null) {
            ...
            List<Landlordpost> posts = this.lpostSvc.getLPosts(lat, lng, radius);
